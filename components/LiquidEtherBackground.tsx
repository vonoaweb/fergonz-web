...
export default function LiquidEtherBackground({
  ...
  useEffect(() => {
    ...
    // Shader code (keeping as strings)
    const face_vert = `
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous, iterations, dt }: any) {
        let fbo_in: THREE.WebGLRenderTarget, fbo_out: THREE.WebGLRenderTarget = this.props.output1;
    ...
    class Poisson extends ShaderPass {
      ...
      update({ iterations }: any) {
        let p_in: THREE.WebGLRenderTarget, p_out: THREE.WebGLRenderTarget = this.props.output1;
        for (let i = 0; i < iterations; i++) {
          if (i % 2 === 0) {
    ...
    class WebGLManager {
      ...
      init() {
        ...
        // Output will be created with default options, then updated via applyOptionsFromProps
