...
export const projects: Project[] = [
  {
    ...
    image: '/images/header_project_UX.webp',
    images: [
      '/images/seguros_v2.webp',
    ],
    link: '#',
    size: 'medium',
    problem:
  ...
  },
  {
    ...
    image: '/images/Mockup_BV_flow.webp',
    images: [
      '/images/XL - Ecom - Consumer - Orders – 1.webp',
      '/images/XL - Ecom - Consumer - Orders – 2.webp',
      '/images/XL - Ecom - Consumer - Orders – 3.webp',
      '/images/XL - Ecom - Consumer - Orders – 4.webp',
      '/images/XL - Ecom - Consumer - Orders – 5.webp',
      '/images/XL - Ecom - Consumer - Orders – 6.webp',
    ],
    link: '#',
    size: 'xlarge',
    problem:
  ...
  },
  {
    ...
    image: '/images/dashboard_cliente_2.webp',
    images: [
      '/images/afo_2.webp',
      '/images/dashboard_cliente_2.webp',
      '/images/dashboard_op.webp',
      '/images/dashboard_operaciones_.webp',
      '/images/om31.webp',
      '/images/oiqdl.webp',
    ],
    link: '#',
